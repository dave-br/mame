...
public:
	...
	symbol_entry &add(const char *name, const std::vector<std::pair<offs_t,offs_t>> & scope_ranges, u64 value);
	symbol_entry &add(const char *name, const std::vector<std::pair<offs_t,offs_t>> & scope_ranges, const std::string & expression);
