...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_SRCDBGINFO,                                 nullptr,     core_options::option_type::MULTIPATH,  "source-level debugging information for use debugging emulated machine" },
	...
	{ OPTION_SRCDBGSPACESPERTAB,                         "4",         core_options::option_type::INTEGER,    "number of spaces to display in source debugging view and trace files for each tab stop from source files" },
